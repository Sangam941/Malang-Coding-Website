    ...
    <section ref={sectionRef} id="project" className="py-10 transition-colors duration-300" style={{ backgroundColor: "var(--bg-color)" }}>
      <div className="container mx-auto px-3">
        ...
        <div className="text-center mb-10">
          <div
            className={`inline-flex items-center space-x-2 backdrop-blur-sm shadow rounded-full px-4 py-2 text-sm mb-6 transition-all duration-200 translate-y-0 opacity-100`}
